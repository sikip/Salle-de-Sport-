...
@Component({
  selector: 'app-paydetch',
  templateUrl: './paydetch.component.html',
  styleUrls: ['./paydetch.component.css']
})
export class PaydetchComponent implements OnInit {
