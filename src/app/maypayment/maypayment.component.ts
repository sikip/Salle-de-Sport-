...
@Component({
  selector: 'app-maypayment',
  templateUrl: './maypayment.component.html',
  styleUrls: ['./maypayment.component.css']
})
export class MaypaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(params => {
      ...
      if(this.userId){
        ...
        this.userpanierpayment(this.userId);
  ...
  userpanierpayment(userId: number): void {
    this.gaeageService.userpanierpayment(userId)
      .subscribe(chops => {
